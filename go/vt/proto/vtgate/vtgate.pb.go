...
type TransactionAccessMode int32

const (
	TransactionAccessMode_INVALID                  TransactionAccessMode = 0 // default value
	TransactionAccessMode_WITH_CONSISTENT_SNAPSHOT TransactionAccessMode = 1
	TransactionAccessMode_READ_WRITE               TransactionAccessMode = 2
	TransactionAccessMode_READ_ONLY                TransactionAccessMode = 3
)

// Enum value maps for TransactionAccessMode.
var (
	TransactionAccessMode_name = map[int32]string{
		0: "INVALID",
		1: "WITH_CONSISTENT_SNAPSHOT",
		2: "READ_WRITE",
		3: "READ_ONLY",
	}
	TransactionAccessMode_value = map[string]int32{
		"INVALID":                  0,
		"WITH_CONSISTENT_SNAPSHOT": 1,
		"READ_WRITE":               2,
		"READ_ONLY":                3,
	}
)

func (x TransactionAccessMode) Enum() *TransactionAccessMode {
	p := new(TransactionAccessMode)
	*p = x
	return p
}

func (x TransactionAccessMode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TransactionAccessMode) Descriptor() protoreflect.EnumDescriptor {
	return file_vtgate_proto_enumTypes[1].Descriptor()
}

func (TransactionAccessMode) Type() protoreflect.EnumType {
	return &file_vtgate_proto_enumTypes[1]
}

func (x TransactionAccessMode) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TransactionAccessMode.Descriptor instead.
func (TransactionAccessMode) EnumDescriptor() ([]byte, []int) {
...
func (CommitOrder) Descriptor() protoreflect.EnumDescriptor {
	return file_vtgate_proto_enumTypes[2].Descriptor()
}

func (CommitOrder) Type() protoreflect.EnumType {
	return &file_vtgate_proto_enumTypes[2]
}
...
type ReadAfterWriteConsistency int32

const (
	// NONE uses the read after write scope set by the VTGate flag 'read_after_write_consistency'.
	ReadAfterWriteConsistency_EVENTUAL ReadAfterWriteConsistency = 0
	// SESSION is used to designate session read after write consistency.
	ReadAfterWriteConsistency_SESSION ReadAfterWriteConsistency = 1
	// INSTANCE is used to designate instance read after write consistency.
	ReadAfterWriteConsistency_INSTANCE ReadAfterWriteConsistency = 2
	// GLOBAL is used to designate global read after write consistency.
	ReadAfterWriteConsistency_GLOBAL ReadAfterWriteConsistency = 3
)

// Enum value maps for ReadAfterWriteConsistency.
var (
	ReadAfterWriteConsistency_name = map[int32]string{
		0: "EVENTUAL",
		1: "SESSION",
		2: "INSTANCE",
		3: "GLOBAL",
	}
	ReadAfterWriteConsistency_value = map[string]int32{
		"EVENTUAL": 0,
		"SESSION":  1,
		"INSTANCE": 2,
		"GLOBAL":   3,
...
func (x ReadAfterWriteConsistency) Enum() *ReadAfterWriteConsistency {
	p := new(ReadAfterWriteConsistency)
	*p = x
	return p
}

func (x ReadAfterWriteConsistency) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ReadAfterWriteConsistency) Descriptor() protoreflect.EnumDescriptor {
	return file_vtgate_proto_enumTypes[3].Descriptor()
}

func (ReadAfterWriteConsistency) Type() protoreflect.EnumType {
	return &file_vtgate_proto_enumTypes[3]
}

func (x ReadAfterWriteConsistency) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ReadAfterWriteConsistency.Descriptor instead.
func (ReadAfterWriteConsistency) EnumDescriptor() ([]byte, []int) {
...
type Session struct {
	...
	// RewriteTableNameWithDbNamePrefix is the flag to enable add database prefix for tableName
	RewriteTableNameWithDbNamePrefix bool `protobuf:"varint,28,opt,name=RewriteTableNameWithDbNamePrefix,proto3" json:"RewriteTableNameWithDbNamePrefix,omitempty"`
	// read_only_transaction_policy is the policy used for read only transaction, such as enable and disable
	EnableReadWriteSplitForReadOnlyTxn bool `protobuf:"varint,29,opt,name=EnableReadWriteSplitForReadOnlyTxn,proto3" json:"EnableReadWriteSplitForReadOnlyTxn,omitempty"`
	// system var to receive input from user and change the EnableReadWriteSplitForReadOnlyTxn value when not in a txn
	ReadWriteSplitForReadOnlyTxnUserInput bool `protobuf:"varint,30,opt,name=ReadWriteSplitForReadOnlyTxnUserInput,proto3" json:"ReadWriteSplitForReadOnlyTxnUserInput,omitempty"`
	// TxAccessMode
	TransactionAccessMode TransactionAccessMode `protobuf:"varint,31,opt,name=transaction_access_mode,json=transactionAccessMode,proto3,enum=vtgate.TransactionAccessMode" json:"transaction_access_mode,omitempty"`
	// when enabled, vtgate will intercpet DELETE and UPDATE SQLs that are without WHERE condition
	EnableInterceptionForDMLWithoutWhere bool `protobuf:"varint,32,opt,name=EnableInterceptionForDMLWithoutWhere,proto3" json:"EnableInterceptionForDMLWithoutWhere,omitempty"`
	// when enabled, vtgate will display the type of SQL execution vttablet
	EnableDisplaySQLExecutionVTTabletType bool `protobuf:"varint,33,opt,name=EnableDisplaySQLExecutionVTTabletType,proto3" json:"EnableDisplaySQLExecutionVTTabletType,omitempty"`
	// used to resolve tablet type/types to load balance
	ResolverOptions *ResolverOptions `protobuf:"bytes,34,opt,name=resolver_options,json=resolverOptions,proto3" json:"resolver_options,omitempty"`
}
...
func (x *Session) GetReadWriteSplittingRatio() int32 {
	if x != nil {
		return x.ReadWriteSplittingRatio
	}
	return 0
}

func (x *Session) GetRewriteTableNameWithDbNamePrefix() bool {
	if x != nil {
		return x.RewriteTableNameWithDbNamePrefix
	}
	return false
}

func (x *Session) GetEnableReadWriteSplitForReadOnlyTxn() bool {
	if x != nil {
		return x.EnableReadWriteSplitForReadOnlyTxn
	}
	return false
}

func (x *Session) GetReadWriteSplitForReadOnlyTxnUserInput() bool {
	if x != nil {
		return x.ReadWriteSplitForReadOnlyTxnUserInput
	}
	return false
}

func (x *Session) GetTransactionAccessMode() TransactionAccessMode {
	if x != nil {
		return x.TransactionAccessMode
	}
	return TransactionAccessMode_INVALID
}

func (x *Session) GetEnableInterceptionForDMLWithoutWhere() bool {
	if x != nil {
		return x.EnableInterceptionForDMLWithoutWhere
	}
	return false
}

func (x *Session) GetEnableDisplaySQLExecutionVTTabletType() bool {
	if x != nil {
		return x.EnableDisplaySQLExecutionVTTabletType
	}
	return false
}

func (x *Session) GetResolverOptions() *ResolverOptions {
	if x != nil {
...
type ResolverOptions struct {
	...
	UserHintTabletType      topodata.TabletType `protobuf:"varint,1,opt,name=user_hint_tablet_type,json=userHintTabletType,proto3,enum=topodata.TabletType" json:"user_hint_tablet_type,omitempty"`
	KeyspaceTabletType      topodata.TabletType `protobuf:"varint,2,opt,name=keyspace_tablet_type,json=keyspaceTabletType,proto3,enum=topodata.TabletType" json:"keyspace_tablet_type,omitempty"`
	SuggestedTabletType     topodata.TabletType `protobuf:"varint,3,opt,name=suggested_tablet_type,json=suggestedTabletType,proto3,enum=topodata.TabletType" json:"suggested_tablet_type,omitempty"`
	ReadWriteSplittingRatio int32               `protobuf:"varint,4,opt,name=ReadWriteSplittingRatio,proto3" json:"ReadWriteSplittingRatio,omitempty"`
}

func (x *ResolverOptions) Reset() {
	*x = ResolverOptions{}
	if protoimpl.UnsafeEnabled {
...
func (x *ResolverOptions) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ResolverOptions) ProtoMessage() {}

func (x *ResolverOptions) ProtoReflect() protoreflect.Message {
	mi := &file_vtgate_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ResolverOptions.ProtoReflect.Descriptor instead.
func (*ResolverOptions) Descriptor() ([]byte, []int) {
	return file_vtgate_proto_rawDescGZIP(), []int{1}
}

func (x *ResolverOptions) GetUserHintTabletType() topodata.TabletType {
	if x != nil {
		return x.UserHintTabletType
	}
	return topodata.TabletType(0)
}

func (x *ResolverOptions) GetKeyspaceTabletType() topodata.TabletType {
	if x != nil {
		return x.KeyspaceTabletType
	}
	return topodata.TabletType(0)
}

func (x *ResolverOptions) GetSuggestedTabletType() topodata.TabletType {
	if x != nil {
		return x.SuggestedTabletType
	}
	return topodata.TabletType(0)
}

func (x *ResolverOptions) GetReadWriteSplittingRatio() int32 {
	if x != nil {
		return x.ReadWriteSplittingRatio
	}
	return 0
...
type ReadAfterWrite struct {
	...
	ReadAfterWriteConsistency ReadAfterWriteConsistency `protobuf:"varint,4,opt,name=read_after_write_consistency,json=readAfterWriteConsistency,proto3,enum=vtgate.ReadAfterWriteConsistency" json:"read_after_write_consistency,omitempty"`
}
...
func (x *ReadAfterWrite) GetReadAfterWriteConsistency() ReadAfterWriteConsistency {
	if x != nil {
		return x.ReadAfterWriteConsistency
	}
	return ReadAfterWriteConsistency_EVENTUAL
}
...
var file_vtgate_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xcd, 0x12, 0x0a, 0x07, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x25,
	...
	,
	...
	,
	...
	,
	...
	0x10, 0x04, 0x22, 0xa6, 0x02, 0x0a, 0x0f, 0x52, 0x65, 0x73, 0x6f, 0x6c, 0x76, 0x65, 0x72, 0x4f,
	0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x47, 0x0a, 0x15, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x68,
	0x69, 0x6e, 0x74, 0x5f, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x74, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x74, 0x6f, 0x70, 0x6f, 0x64, 0x61, 0x74, 0x61,
	0x2e, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x74, 0x54, 0x79, 0x70, 0x65, 0x52, 0x12, 0x75, 0x73, 0x65,
	0x72, 0x48, 0x69, 0x6e, 0x74, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x74, 0x54, 0x79, 0x70, 0x65, 0x12,
	0x46, 0x0a, 0x14, 0x6b, 0x65, 0x79, 0x73, 0x70, 0x61, 0x63, 0x65, 0x5f, 0x74, 0x61, 0x62, 0x6c,
	...
	,
	...
	0x54, 0x72, 0x61, 0x63, 0x6b, 0x47, 0x74, 0x69, 0x64, 0x73, 0x12, 0x62, 0x0a, 0x1c, 0x72, 0x65,
	0x61, 0x64, 0x5f, 0x61, 0x66, 0x74, 0x65, 0x72, 0x5f, 0x77, 0x72, 0x69, 0x74, 0x65, 0x5f, 0x63,
	0x6f, 0x6e, 0x73, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x63, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e,
	0x32, 0x21, 0x2e, 0x76, 0x74, 0x67, 0x61, 0x74, 0x65, 0x2e, 0x52, 0x65, 0x61, 0x64, 0x41, 0x66,
	0x74, 0x65, 0x72, 0x57, 0x72, 0x69, 0x74, 0x65, 0x43, 0x6f, 0x6e, 0x73, 0x69, 0x73, 0x74, 0x65,
	0x6e, 0x63, 0x79, 0x52, 0x19, 0x72, 0x65, 0x61, 0x64, 0x41, 0x66, 0x74, 0x65, 0x72, 0x57, 0x72,
	0x69, 0x74, 0x65, 0x43, 0x6f, 0x6e, 0x73, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x63, 0x79, 0x22, 0xaa,
	...
	0x04, 0x4a, 0x04, 0x08, 0x04, 0x10, 0x05, 0x4a, 0x04, 0x08, 0x05, 0x10, 0x06, 0x22, 0x43, 0x0a,
	...
	0x6c, 0x74, 0x22, 0x5d, 0x0a, 0x19, 0x52, 0x65, 0x73, 0x6f, 0x6c, 0x76, 0x65, 0x54, 0x72, 0x61,
	...
	0xa0, 0x01, 0x0a, 0x0c, 0x56, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x46, 0x6c, 0x61, 0x67, 0x73,
	...
	0x6c, 0x73, 0x22, 0xf6, 0x01, 0x0a, 0x0e, 0x56, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2c, 0x0a, 0x09, 0x63, 0x61, 0x6c, 0x6c, 0x65, 0x72, 0x5f,
	0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x76, 0x74, 0x72, 0x70, 0x63,
	0x2e, 0x43, 0x61, 0x6c, 0x6c, 0x65, 0x72, 0x49, 0x44, 0x52, 0x08, 0x63, 0x61, 0x6c, 0x6c, 0x65,
	...
	0x2a, 0x61, 0x0a, 0x15, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x41,
	0x63, 0x63, 0x65, 0x73, 0x73, 0x4d, 0x6f, 0x64, 0x65, 0x12, 0x0b, 0x0a, 0x07, 0x49, 0x4e, 0x56,
	0x41, 0x4c, 0x49, 0x44, 0x10, 0x00, 0x12, 0x1c, 0x0a, 0x18, 0x57, 0x49, 0x54, 0x48, 0x5f, 0x43,
	0x4f, 0x4e, 0x53, 0x49, 0x53, 0x54, 0x45, 0x4e, 0x54, 0x5f, 0x53, 0x4e, 0x41, 0x50, 0x53, 0x48,
	0x4f, 0x54, 0x10, 0x01, 0x12, 0x0e, 0x0a, 0x0a, 0x52, 0x45, 0x41, 0x44, 0x5f, 0x57, 0x52, 0x49,
	0x54, 0x45, 0x10, 0x02, 0x12, 0x0d, 0x0a, 0x09, 0x52, 0x45, 0x41, 0x44, 0x5f, 0x4f, 0x4e, 0x4c,
	0x59, 0x10, 0x03, 0x2a, 0x3c, 0x0a, 0x0b, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x4f, 0x72, 0x64,
	...
	0x03, 0x2a, 0x50, 0x0a, 0x19, 0x52, 0x65, 0x61, 0x64, 0x41, 0x66, 0x74, 0x65, 0x72, 0x57, 0x72,
	0x69, 0x74, 0x65, 0x43, 0x6f, 0x6e, 0x73, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x63, 0x79, 0x12, 0x0c,
	0x0a, 0x08, 0x45, 0x56, 0x45, 0x4e, 0x54, 0x55, 0x41, 0x4c, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x07,
	0x53, 0x45, 0x53, 0x53, 0x49, 0x4f, 0x4e, 0x10, 0x01, 0x12, 0x0c, 0x0a, 0x08, 0x49, 0x4e, 0x53,
	0x54, 0x41, 0x4e, 0x43, 0x45, 0x10, 0x02, 0x12, 0x0a, 0x0a, 0x06, 0x47, 0x4c, 0x4f, 0x42, 0x41,
	0x4c, 0x10, 0x03, 0x42, 0x36, 0x0a, 0x0f, 0x69, 0x6f, 0x2e, 0x76, 0x69, 0x74, 0x65, 0x73, 0x73,
...
var file_vtgate_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_vtgate_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_vtgate_proto_goTypes = []interface{}{
	(TransactionMode)(0),               // 0: vtgate.TransactionMode
	(TransactionAccessMode)(0),         // 1: vtgate.TransactionAccessMode
	(CommitOrder)(0),                   // 2: vtgate.CommitOrder
	(ReadAfterWriteConsistency)(0),     // 3: vtgate.ReadAfterWriteConsistency
	(*Session)(nil),                    // 4: vtgate.Session
	(*ResolverOptions)(nil),            // 5: vtgate.ResolverOptions
	(*ReadAfterWrite)(nil),             // 6: vtgate.ReadAfterWrite
	...
	(*ResolveTransactionRequest)(nil),  // 13: vtgate.ResolveTransactionRequest
	(*ResolveTransactionResponse)(nil), // 14: vtgate.ResolveTransactionResponse
	(*VStreamFlags)(nil),               // 15: vtgate.VStreamFlags
	(*VStreamRequest)(nil),             // 16: vtgate.VStreamRequest
	(*VStreamResponse)(nil),            // 17: vtgate.VStreamResponse
	(*PrepareRequest)(nil),             // 18: vtgate.PrepareRequest
	(*PrepareResponse)(nil),            // 19: vtgate.PrepareResponse
	(*CloseSessionRequest)(nil),        // 20: vtgate.CloseSessionRequest
	(*CloseSessionResponse)(nil),       // 21: vtgate.CloseSessionResponse
	(*Session_ShardSession)(nil),       // 22: vtgate.Session.ShardSession
	nil,                                // 23: vtgate.Session.UserDefinedVariablesEntry
	nil,                                // 24: vtgate.Session.SystemVariablesEntry
	nil,                                // 25: vtgate.Session.AdvisoryLockEntry
	(*query.ExecuteOptions)(nil),       // 26: query.ExecuteOptions
	(*query.QueryWarning)(nil),         // 27: query.QueryWarning
	(topodata.TabletType)(0),           // 28: topodata.TabletType
	(*vtrpc.CallerID)(nil),             // 29: vtrpc.CallerID
	(*query.BoundQuery)(nil),           // 30: query.BoundQuery
	(*vtrpc.RPCError)(nil),             // 31: vtrpc.RPCError
	(*query.QueryResult)(nil),          // 32: query.QueryResult
	(*query.ResultWithError)(nil),      // 33: query.ResultWithError
	(*binlogdata.VGtid)(nil),           // 34: binlogdata.VGtid
	(*binlogdata.Filter)(nil),          // 35: binlogdata.Filter
	(*binlogdata.VEvent)(nil),          // 36: binlogdata.VEvent
	(*query.Field)(nil),                // 37: query.Field
	(*query.Target)(nil),               // 38: query.Target
	(*topodata.TabletAlias)(nil),       // 39: topodata.TabletAlias
	(*query.BindVariable)(nil),         // 40: query.BindVariable
}
var file_vtgate_proto_depIdxs = []int32{
	22, // 0: vtgate.Session.shard_sessions:type_name -> vtgate.Session.ShardSession
	26, // 1: vtgate.Session.options:type_name -> query.ExecuteOptions
	0,  // 2: vtgate.Session.transaction_mode:type_name -> vtgate.TransactionMode
	27, // 3: vtgate.Session.warnings:type_name -> query.QueryWarning
	22, // 4: vtgate.Session.pre_sessions:type_name -> vtgate.Session.ShardSession
	22, // 5: vtgate.Session.post_sessions:type_name -> vtgate.Session.ShardSession
	23, // 6: vtgate.Session.user_defined_variables:type_name -> vtgate.Session.UserDefinedVariablesEntry
	24, // 7: vtgate.Session.system_variables:type_name -> vtgate.Session.SystemVariablesEntry
	22, // 8: vtgate.Session.lock_session:type_name -> vtgate.Session.ShardSession
	6,  // 9: vtgate.Session.read_after_write:type_name -> vtgate.ReadAfterWrite
	25, // 10: vtgate.Session.advisory_lock:type_name -> vtgate.Session.AdvisoryLockEntry
	1,  // 11: vtgate.Session.transaction_access_mode:type_name -> vtgate.TransactionAccessMode
	5,  // 12: vtgate.Session.resolver_options:type_name -> vtgate.ResolverOptions
	28, // 13: vtgate.ResolverOptions.user_hint_tablet_type:type_name -> topodata.TabletType
	28, // 14: vtgate.ResolverOptions.keyspace_tablet_type:type_name -> topodata.TabletType
	28, // 15: vtgate.ResolverOptions.suggested_tablet_type:type_name -> topodata.TabletType
	3,  // 16: vtgate.ReadAfterWrite.read_after_write_consistency:type_name -> vtgate.ReadAfterWriteConsistency
	29, // 17: vtgate.ExecuteRequest.caller_id:type_name -> vtrpc.CallerID
	4,  // 18: vtgate.ExecuteRequest.session:type_name -> vtgate.Session
	30, // 19: vtgate.ExecuteRequest.query:type_name -> query.BoundQuery
	31, // 20: vtgate.ExecuteResponse.error:type_name -> vtrpc.RPCError
	4,  // 21: vtgate.ExecuteResponse.session:type_name -> vtgate.Session
	32, // 22: vtgate.ExecuteResponse.result:type_name -> query.QueryResult
	29, // 23: vtgate.ExecuteBatchRequest.caller_id:type_name -> vtrpc.CallerID
	4,  // 24: vtgate.ExecuteBatchRequest.session:type_name -> vtgate.Session
	30, // 25: vtgate.ExecuteBatchRequest.queries:type_name -> query.BoundQuery
	31, // 26: vtgate.ExecuteBatchResponse.error:type_name -> vtrpc.RPCError
	4,  // 27: vtgate.ExecuteBatchResponse.session:type_name -> vtgate.Session
	33, // 28: vtgate.ExecuteBatchResponse.results:type_name -> query.ResultWithError
	29, // 29: vtgate.StreamExecuteRequest.caller_id:type_name -> vtrpc.CallerID
	30, // 30: vtgate.StreamExecuteRequest.query:type_name -> query.BoundQuery
	4,  // 31: vtgate.StreamExecuteRequest.session:type_name -> vtgate.Session
	32, // 32: vtgate.StreamExecuteResponse.result:type_name -> query.QueryResult
	29, // 33: vtgate.ResolveTransactionRequest.caller_id:type_name -> vtrpc.CallerID
	29, // 34: vtgate.VStreamRequest.caller_id:type_name -> vtrpc.CallerID
	28, // 35: vtgate.VStreamRequest.tablet_type:type_name -> topodata.TabletType
	34, // 36: vtgate.VStreamRequest.vgtid:type_name -> binlogdata.VGtid
	35, // 37: vtgate.VStreamRequest.filter:type_name -> binlogdata.Filter
	15, // 38: vtgate.VStreamRequest.flags:type_name -> vtgate.VStreamFlags
	36, // 39: vtgate.VStreamResponse.events:type_name -> binlogdata.VEvent
	29, // 40: vtgate.PrepareRequest.caller_id:type_name -> vtrpc.CallerID
	4,  // 41: vtgate.PrepareRequest.session:type_name -> vtgate.Session
	30, // 42: vtgate.PrepareRequest.query:type_name -> query.BoundQuery
	31, // 43: vtgate.PrepareResponse.error:type_name -> vtrpc.RPCError
	4,  // 44: vtgate.PrepareResponse.session:type_name -> vtgate.Session
	37, // 45: vtgate.PrepareResponse.fields:type_name -> query.Field
	29, // 46: vtgate.CloseSessionRequest.caller_id:type_name -> vtrpc.CallerID
	4,  // 47: vtgate.CloseSessionRequest.session:type_name -> vtgate.Session
	31, // 48: vtgate.CloseSessionResponse.error:type_name -> vtrpc.RPCError
	38, // 49: vtgate.Session.ShardSession.target:type_name -> query.Target
	39, // 50: vtgate.Session.ShardSession.tablet_alias:type_name -> topodata.TabletAlias
	40, // 51: vtgate.Session.UserDefinedVariablesEntry.value:type_name -> query.BindVariable
